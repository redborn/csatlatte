<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<style>
	.id-security-fail {height:340px; font-size:13px;}
	#id-security-fail-btn-group {text-align:right; width:auto;}
	#id-security-fail-btn-cancel {background:#ffd0c9; text-shadow:none;}
	#id-security-fail-btn-success {background:#c9e6ff; text-shadow:none;}

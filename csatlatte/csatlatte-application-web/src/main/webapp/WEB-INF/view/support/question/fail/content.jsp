	...
	<div class="panel-body">
		<div class="support-question-fail">
			...
			<div class="support-question-fail-message">
				...
				<p>수능라떼팀의 서버와 연결 상태 불안정으로 전달하지 못했을 수도 있습니다.</p>
				<p>인터넷 상태 등을 확인하시기 바랍니다.</p><br/>
				<p>문의를 다시 시도하시려면 브라우저의 뒤로가기 버튼이나 우측 하단의 버튼을 누르시면 됩니다.</p><br/>
			</div>
			<div class="support-question-fail-retry-quesiton">
				<a class="btn btn-default" href="#">문의하기</a>
			</div>
		</div>
	</div>
</div>
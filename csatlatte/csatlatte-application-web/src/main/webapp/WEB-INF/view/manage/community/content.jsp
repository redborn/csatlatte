	...
	<c:forEach items="${list}" var="list">
		<tr>
			...
			<td><div id="blind${list.communitySequence}">
				<button type="button" class="btn btn-default close"><div id="${list.communitySequence}" data-toggle="modal" data-target="#manage-community-blind" class="<c:if test="${list.blind eq false}">glyphicon glyphicon glyphicon-lock manage-community-blind</c:if>"></div></button>
			</div></td>
		</tr>
	</c:forEach>
	</tbody>

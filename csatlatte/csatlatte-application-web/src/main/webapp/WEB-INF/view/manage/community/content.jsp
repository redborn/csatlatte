	...
	<c:forEach items="${list}" var="community">
		<tr>
			...
			<td><div id="blind${community.communitySequence}">
				<button type="button" class="btn btn-default close"><span id="${community.communitySequence}" data-toggle="modal" data-target="#manage-community-blind" class="<c:if test="${!community.blind}">glyphicon glyphicon glyphicon-lock manage-community-blind</c:if>"></span></button>
			</div></td>
		</tr>
	</c:forEach>
	</tbody>

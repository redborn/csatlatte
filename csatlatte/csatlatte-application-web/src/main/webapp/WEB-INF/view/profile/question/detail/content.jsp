...
<div class="panel panel-default">
	...
	<div class="panel-footer">
		<div class="profile-question-detail-message">
			<p><strong>원하시는 답이 아닌가요?</strong></p>
			<p>궁금하신 사항이 해결되지 않았다면 다시한번 수능라떼 팀에게 문의해주세요.</p>
		</div>
		<div class="profile-question-detail-btn">
			<a class="btn btn-default" href="<c:url value="/support/question"/>">문의하기</a>
		</div>
	</div>
</div>
<div class="profile-question-detail-btn-group">
	<a class="btn btn-default" href="<c:url value="/profile/question"/>">목록보기</a>
	<input type="submit" class="btn btn-default" id="profile-question-detail-btn-delete" value="삭제하기">
</div>
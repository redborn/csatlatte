	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="<c:url value="/myinfo"/>">
					<img alt="profile" src="<c:url value="/resources/csatlatte/images/btn/btn_my_info.png"/>" />
				</a></li>
				<li><a href="<c:url value="/main"/>" class="navbar-right-icon">
					<img alt="login" src="<c:url value="/resources/csatlatte/images/btn/btn_logout.png"/>" />
				</a></li>
			</ul>
		</div>
	</div>
